...
@SourceType(value = "ActCRMARP", label = "ActCRM",uiConfig = "actcrm-layout.json")
public class ActCRMConf extends AbstractArpConf<ActCRMConf> {
  private static final String ARP_FILENAME = "arp/implementation/actcrm-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.actcrm.ActCRMDriver";
