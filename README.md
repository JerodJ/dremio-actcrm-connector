...
3. Download and install the [Act CRM JDBC Driver from CData](https://www.cdata.com/drivers/actcrm/download/jdbc)* and copy the JAR file to the /jars/3rdparty/ directory of your Dremio installation. For example:
